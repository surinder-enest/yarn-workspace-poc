...
export default class Audio extends Component<IProps, IState> {
        ...
        return <>
            <div style={{
                ...
                <div style={{ padding: 0, textAlign: "center" }}>
                    <i style={{
                        background: "url(https://staging.mindmemobile.com/images/Audio-grey-small.svg) no-repeat",
                        padding: "4px 18px",
    ...
    private getAudioHtmlWithShowType(): ReactNode {
        const { buttonStyles, styles, showType, buttonText, imageUrl } = this.props.audio;
        const { width } = styles;
    ...
    render() {
        ...
        return <div style={styles}>
            <div style={{ position: 'relative', textAlign: 'center', minHeight: 'inherit' }} >
                {
                    isDefaultMedia
                        ? <PlaceHolder builderElementType={BUILDER_ELEMENTS.AUDIO} text="Select Audio" />
