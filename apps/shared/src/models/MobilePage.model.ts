...
export class MobilePageModel {
  ...
  constructor(data?: MobilePageModel) {
    ...
    this.isPageNotFound = data?.isPageNotFound || false;
    this.isPageDeleted = data?.isPageDeleted || false;
    this.isPageInActive = data?.isPageInActive || false;
    this.isAccountActive = data?.isAccountActive || false;
  }
  ...
  static deserialize(apiModel: APIMobileData): MobilePageModel {
    const data: MobilePageModel = {
      ...
      pageStyles: MobilePageModel.deserializeStyles(
        apiModel?.MobilePageData?.PageStyling
      ),
      builderElements: BuilderElementModel.deserializeList(
        apiModel?.MobilePageData?.MobilePageBuilderComponents,
        apiModel?.ContactInfo?.ContactId
      ),
      ...
      isPageInActive: apiModel?.IsPageInActive,
      isPageNotFound: apiModel?.IsPageNotFound,
      isPageDeleted: apiModel?.IsPageDeleted,
      isAccountActive: apiModel?.IsAccountActive,
    };
