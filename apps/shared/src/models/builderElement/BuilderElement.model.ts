...
export class BuilderElementModel {
  ...
  static deserialize(
    ...
    const data: BuilderElementModel = {
      ...
      link: ButtonModel.deserialize(apiModel?.Link, contactId, apiModel?.BuilderElementType),
      mobilePageElement: ButtonModel.deserialize(apiModel?.MobilePage, contactId, apiModel?.BuilderElementType),
      button: ButtonModel.deserialize(apiModel?.Button, contactId, apiModel?.BuilderElementType),
